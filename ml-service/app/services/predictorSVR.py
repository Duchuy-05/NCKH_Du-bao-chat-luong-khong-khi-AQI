...
# TODO: nếu app/data/aqi.py đã có hàm phân loại mức AQI (aqi_to_level),
# import và dùng lại ở đây thay vì định nghĩa lại — tránh lệch logic giữa
# pipeline làm sạch dữ liệu và pipeline dự báo.
