...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      id="main-footer"
      className="w-full bg-slate-100 dark:bg-black text-slate-600 dark:text-slate-300 border-t border-slate-200 dark:border-slate-800/80 pt-16 pb-12 transition-colors"
    >
